...
public class SecondActivityJ extends BaseActivityJ {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnNavigate).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SecondActivityJ.this, ThirdActivityJ.class));
            }
        });
    ...
    public void onNetworkChanged(NetworkResponse res) {
        ((TextView) findViewById(R.id.textView1)).setText("第二页实时网络状况:\n类型" + res.networkType + "\n可用性" + res.availability);
    }
}
